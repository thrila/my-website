  ...
  return (
    <div className=' mx-auto'>
      <div className=' flex items-center space-x-5 md:space-x-10 m-3'>
        ...
        <a target="_blank" rel="noopener noreferrer" href='https://twitter.com/nino_da_creator' className='text-white text-4xl md:text-6xl font-thin hover:text-button-before' aria-label='x'> <RiTwitterXFill /> </a>
